...
public class Global
{
    ...
    public static String getConfig(String key)
    {
        ...
        if (value == null||value.equals("null"))
        {
            ...
            try
            {
                ...
                if (value==null||value.equals("null")){
                    yamlMap = YamlUtil.loadYaml("application-druid.yml");
                    value = String.valueOf(YamlUtil.getProperty(yamlMap, key));
                }
                map.put(key, value != null&&!value.equals("null") ? value : StringUtils.EMPTY);
            }
            catch (Exception e)
            {
    ...
    public static boolean isNetFile() {return Boolean.valueOf(getConfig("ruoyi.isNetFile"));
    }
    ...
    public static String getNetFileBaseUrl() {
        return "https://ruoyi.gz.bcebos.com/";
    }
}
