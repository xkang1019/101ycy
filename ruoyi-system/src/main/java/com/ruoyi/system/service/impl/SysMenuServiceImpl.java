...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public List<SysMenu> selectMenusByUser(SysUser user)
    {
        ...
        {
            menus = menuMapper.selectMenusByUserId(Convert.toLong(user.getUserId()));
        }
    ...
    public List<Map<String, Object>> roleMenuTreeData(SysRole role)
    {
        ...
        {
            List<String> roleMenuList = menuMapper.selectMenuTree(Convert.toLong(roleId));
    ...
    {
        if (menu.getMenuId()==null) menu.setMenuId(IdUtils.getIdStr());
    ...
    {
        String menuId = StringUtils.nvl(menu.getMenuId(),"-1");
        SysMenu info = menuMapper.checkMenuNameUnique(menu.getMenuName(), Convert.toLong(menu.getParentId()));
    ...
    public List<SysMenu> getChildPerms(List<SysMenu> list, int parentId)
    {
        ...
        for (Iterator<SysMenu> iterator = list.iterator(); iterator.hasNext();)
        {
            ...
            if (Convert.toLong(t.getParentId()) == parentId)
            {
                recursionFn(list, t);
                returnList.add(t);
            }
