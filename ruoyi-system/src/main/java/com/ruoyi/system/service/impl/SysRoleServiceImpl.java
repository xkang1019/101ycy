...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    {
        // 新增角色信息
        if (role.getRoleId()==null) role.setRoleId(IdUtils.getIdStr());
    ...
    public int updateRole(SysRole role)
    {
        ...
        // 删除角色与菜单关联
        roleMenuMapper.deleteRoleMenuByRoleId(Convert.toLong(role.getRoleId()));
        return insertRoleMenu(role);
    }
    ...
    public int updateRule(SysRole role)
    {
        ...
        roleMapper.updateRole(role);
        // 删除角色与部门关联
        roleDeptMapper.deleteRoleDeptByRoleId(Convert.toLong(role.getRoleId()));
        // 新增角色和部门信息（数据权限）
    ...
    {
        String roleId = StringUtils.nvl(role.getRoleId(),"-1") ;
