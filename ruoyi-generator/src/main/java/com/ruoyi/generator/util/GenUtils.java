...
public class GenUtils
{
     ...
     * 生成代码
     */
    public static void generatorCode(TableInfo table, List<ColumnInfo> columns, ZipOutputStream zip)
    {
        // 表名转换成Java属性名
    ...
    {
        String packageName = "com.ruoyi.business";
        try {
            packageName = Global.getPackageName();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    static
    {
        ...
        javaTypeMap.put("bigint", "String");//避免数值太长,浏览器兼容问题
